...
const ConversationPage = () => {
  ...
  return (
    <div>
      <Heading
        title="Conversation"
        description="Experience blazing-fast conversational AI with Kyojuro Rengoku's precision and intensity."
        icon={MessageSquare}
      />
          ...
          {messages.length === 0 && !isLoading && (
            <div className=" w-full flex flex-col items-center justify-center gap-2">
              <Image
                ...
                height={300}
              />
              <h1 className=" text-lg">No Conversation Started...</h1>
            </div>
          )}
            ...
            {messages.map((message) => (
              <div
                ...
                className={cn(
                  ...
                  message.role === "user" && " justify-end items-center w-full bg-transparent"
                )}
              >
